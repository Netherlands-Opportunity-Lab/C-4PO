...
predictors <- readRDS("case1_preterm_birth/PTB_data/ptb_37weeks/predictors_full_model37.rds")
...
rf_full <- ranger(premature_birth37 ~ . , data = pretbirth_train, num.trees = 1000, #mtry = 5, min.node.size = 15,
...
# saveRDS(rf_full, "case1_preterm_birth/PTB_output/ptb_37weeks/rf_full37.rds")
...
write_excel_csv2(var_imp_norm, "case1_preterm_birth/PTB_output/ptb_37weeks/RF_VarImp_37full.csv")
...
# try different thresholds 0.144 (threshold at prevalence = 5.48), 0.118 (threshold for 9% highest risks), (threshold for 15% highest risks)
rf_full_prob <- ifelse(rf_full$predictions[,2] > 0.144, 1, 0) %>% as.factor()  
...
rf_full_cm <- confusionMatrix(rf_full_prob, pretbirth_train$premature_birth37, positive = "1")
rf_full_cm
rf_full_cmp <- round(prop.table(confusionMatrix(rf_full_prob, pretbirth_train$premature_birth37, positive = "1")$table),4)*100
rf_full_cmp

rf_full_prob2 <- ifelse(rf_full$predictions[,2] > 0.118, 1, 0) %>% as.factor()  
rf_full_cm2 <- confusionMatrix(rf_full_prob2, pretbirth_train$premature_birth37, positive = "1")
rf_full_cm2
rf_full_cmp2 <- round(prop.table(confusionMatrix(rf_full_prob2, pretbirth_train$premature_birth37, positive = "1")$table),4)*100
rf_full_cmp2
...
saveRDS(pred_rf_full, "case1_preterm_birth/PTB_output/ptb_37weeks/pred_rf_full37.rds")
...
pred_rf_full_class <- ifelse(pred_rf_full$predictions[,2] > 0.1426, 1, 0) %>% as.factor()
# look at the confusionMatrix: accuracy, sensitivity, specificity and the Cohen's Kappa coefficient (Kappa accounts for the possibility of a correct prediction by chance alone (in contrast to Accuracy))
rf_full_pred_cm <- confusionMatrix(pred_rf_full_class, pretbirth_test$premature_birth37, positive = "1")
rf_full_pred_cm
rf_full_pred_cmp <- round(prop.table(confusionMatrix(pred_rf_full_class, pretbirth_test$premature_birth37, positive = "1")$table),4)*100
rf_full_pred_cmp

# try different thresholds, e.g. 0.1168 approx. 10% highest risks
pred_rf_full_class2 <- ifelse(pred_rf_full$predictions[,2] > 0.1168, 1, 0) %>% as.factor()
rf_full_pred_cm2 <- confusionMatrix(pred_rf_full_class2, pretbirth_test$premature_birth37, positive = "1")
rf_full_pred_cm2
rf_full_pred_cmp2 <- round(prop.table(confusionMatrix(pred_rf_full_class2, pretbirth_test$premature_birth37, positive = "1")$table),4)*100
rf_full_pred_cmp2

# look at the area under the ROC curve to assess overall model performance
rf_full_roc <- roc(pretbirth_test$premature_birth37, pred_rf_full$predictions[,2])
auc(rf_full_roc)
rf_full_auc <- auc(rf_full_roc)
plot(rf_full_roc, print.auc = TRUE)
saveRDS(rf_full_roc, "case1_preterm_birth/PTB_output/ptb_37weeks/rf_full37_roc.rds") 
...
PTB_test_cdf_1 <- PTB_test_cdf %>% filter(premature_birth37 == 1)
PTB_test_cdf_0 <- PTB_test_cdf %>% filter(premature_birth37 == 0)
...
write_excel_csv2(PTB_test_cdf_1_list, "case1_preterm_birth/PTB_output/ptb_37weeks/PTB37_test_cdf_1_list.csv")
write_excel_csv2(PTB_test_cdf_0_list, "case1_preterm_birth/PTB_output/ptb_37weeks/PTB37_test_cdf_0_list.csv")
...
saveRDS(pred_rf_full_multi, "case1_preterm_birth/PTB_output/ptb_37weeks/pred_rf_full37_multi.rds")
# look at the predicted probabilities
summary(pred_rf_full_multi$predictions[,2])
hist(pred_rf_full_multi$predictions[,2])
prop.table(table(pretbirth_test_multi$premature_birth37))*100

# classify predictions of test data; predict binary outcome using a predicted probability threshold
# this threshold is set a prevalence, we predict a high risk of PTB for approx. 4.29% of pregnancies
pred_rf_full_multi_class <- ifelse(pred_rf_full_multi$predictions[,2] > 0.163, 1, 0) %>% as.factor()
# look at the confusionMatrix: accuracy, sensitivity, specificity and the Cohen's Kappa coefficient (Kappa accounts for the possibility of a correct prediction by chance alone (in contrast to Accuracy))
rf_full_pred_multi_cm <- confusionMatrix(pred_rf_full_multi_class, pretbirth_test_multi$premature_birth37, positive = "1")
rf_full_pred_multi_cm
rf_full_pred_multi_cmp <- round(prop.table(confusionMatrix(pred_rf_full_multi_class, pretbirth_test_multi$premature_birth37, positive = "1")$table),4)*100
rf_full_pred_multi_cmp

# try different thresholds, e.g. 0.102 approx. 10% highest risks
pred_rf_full_multi_class2 <- ifelse(pred_rf_full_multi$predictions[,2] > 0.102, 1, 0) %>% as.factor()
rf_full_pred_multi_cm2 <- confusionMatrix(pred_rf_full_multi_class2, pretbirth_test_multi$premature_birth37, positive = "1")
rf_full_pred_multi_cm2
rf_full_pred_multi_cmp2 <- round(prop.table(confusionMatrix(pred_rf_full_multi_class2, pretbirth_test_multi$premature_birth37, positive = "1")$table),4)*100
rf_full_pred_multi_cmp2

# look at the area under the ROC curve to assess overall model performance
rf_full_multi_roc <- roc(pretbirth_test_multi$premature_birth37, pred_rf_full_multi$predictions[,2])
auc(rf_full_multi_roc)
rf_full_multi_auc <- auc(rf_full_multi_roc)
plot(rf_full_multi_roc, print.auc = TRUE)
saveRDS(rf_full_multi_roc, "case1_preterm_birth/PTB_output/ptb_37weeks/rf_full37_multi_roc.rds") 
...
# look at predicted probabilities by PTB outcome
PTB_test_multi_cdf_1 <- PTB_test_multi_cdf %>% filter(premature_birth37 == 1)
PTB_test_multi_cdf_0 <- PTB_test_multi_cdf %>% filter(premature_birth37 == 0)
...
write_excel_csv2(PTB_test_multi_cdf_1_list, "case1_preterm_birth/PTB_output/ptb_37weeks/PTB37_test_multi_cdf_1_list.csv")
write_excel_csv2(PTB_test_multi_cdf_0_list, "case1_preterm_birth/PTB_output/ptb_37weeks/PTB37_test_multi_cdf_0_list.csv")
# with these saved, you can later assess classification performance at various thresholds of predicted probability
...
saveRDS(pred_rf_full_primi, "case1_preterm_birth/PTB_output/ptb_37weeks/pred_rf_full37_primi.rds")
# look at the predicted probabilities
summary(pred_rf_full_primi$predictions[,2])
hist(pred_rf_full_primi$predictions[,2])
prop.table(table(pretbirth_test_primi$premature_birth37))*100

# classify predictions of test data; predict binary outcome using a predicted probability threshold
# this threshold is set a prevalence, we predict a high risk of PTB for approx. 7.05% of pregnancies
pred_rf_full_primi_class <- ifelse(pred_rf_full_primi$predictions[,2] > 0.1345, 1, 0) %>% as.factor()
# look at the confusionMatrix: accuracy, sensitivity, specificity and the Cohen's Kappa coefficient (Kappa accounts for the possibility of a correct prediction by chance alone (in contrast to Accuracy))
rf_full_pred_primi_cm <- confusionMatrix(pred_rf_full_primi_class, pretbirth_test_primi$premature_birth37, positive = "1")
rf_full_pred_primi_cm
rf_full_pred_primi_cmp <- round(prop.table(confusionMatrix(pred_rf_full_primi_class, pretbirth_test_primi$premature_birth37, positive = "1")$table),4)*100
rf_full_pred_primi_cmp

# try different thresholds, e.g. 0.124 approx. 10% highest risks
pred_rf_full_primi_class2 <- ifelse(pred_rf_full_primi$predictions[,2] > 0.124, 1, 0) %>% as.factor()
rf_full_pred_primi_cm2 <- confusionMatrix(pred_rf_full_primi_class2, pretbirth_test_primi$premature_birth37, positive = "1")
rf_full_pred_primi_cm2
rf_full_pred_primi_cmp2 <- round(prop.table(confusionMatrix(pred_rf_full_primi_class2, pretbirth_test_primi$premature_birth37, positive = "1")$table),4)*100
rf_full_pred_primi_cmp2

# look at the area under the ROC curve to assess overall model performance
rf_full_primi_roc <- roc(pretbirth_test_primi$premature_birth37, pred_rf_full_primi$predictions[,2])
auc(rf_full_primi_roc)
rf_full_primi_auc <- auc(rf_full_primi_roc)
plot(rf_full_primi_roc, print.auc = TRUE)
saveRDS(rf_full_primi_roc, "case1_preterm_birth/PTB_output/ptb_37weeks/rf_full37_primi_roc.rds") 
...
# look at predicted probabilities by PTB outcome
PTB_test_primi_cdf_1 <- PTB_test_primi_cdf %>% filter(premature_birth37 == 1)
PTB_test_primi_cdf_0 <- PTB_test_primi_cdf %>% filter(premature_birth37 == 0)
...
write_excel_csv2(PTB_test_primi_cdf_1_list, "case1_preterm_birth/PTB_output/ptb_37weeks/PTB37_test_primi_cdf_1_list.csv")
write_excel_csv2(PTB_test_primi_cdf_0_list, "case1_preterm_birth/PTB_output/ptb_37weeks/PTB37_test_primi_cdf_0_list.csv")
# with these saved, you can later assess classification performance at various thresholds of predicted probability



# save all auc
rf_full_auc_names <- list('rf_full_auc' = rf_full_auc, 'rf_full_multi_auc' = rf_full_multi_auc, 'rf_full_primi_auc' = rf_full_primi_auc)
openxlsx::write.xlsx(rf_full_auc_names, file = 'case1_preterm_birth/PTB_output/ptb_37weeks/RF_auc_full37_MI.xlsx')
...
glm_full <- glm(premature_birth37 ~ ., 
...
#saveRDS(glm_full, "case1_preterm_birth/PTB_output/ptb_37weeks/glm_full.rds")
# maybe save the coefficients instead
write_excel_csv2(as.data.frame(glm_full_summary_names), "case1_preterm_birth/PTB_output/ptb_37weeks/glm_full_variablenames.csv")
write_excel_csv2(as.data.frame(glm_full_summary$coefficients), "case1_preterm_birth/PTB_output/ptb_37weeks/glm_full_coefficients.csv")
...
# look at the confusionMatrix: accuracy, sensitivity, specificity and the Cohen's Kappa coefficient (Kappa accounts for the possibility of a correct prediction by chance alone (in contrast to Accuracy))
pred_glm_full_cm <- confusionMatrix(pred_glm_full_class, pretbirth_test$premature_birth37, positive = "1")
pred_glm_full_cm
pred_glm_full_cmp <- round(prop.table(confusionMatrix(pred_glm_full_class, pretbirth_test$premature_birth37, positive = "1")$table),4)*100
pred_glm_full_cmp

# try a different threshold value
pred_glm_full_class2 <- ifelse(pred_glm_full >= 0.025, 1, 0) %>% as.factor()
pred_glm_full_cm2 <- confusionMatrix(pred_glm_full_class2, pretbirth_test$premature_birth37, positive = "1")
pred_glm_full_cm2
pred_glm_full_cmp2 <- round(prop.table(confusionMatrix(pred_glm_full_class2, pretbirth_test$premature_birth37, positive = "1")$table),4)*100
pred_glm_full_cmp2

# look at the area under the ROC curve to assess overall model performance
glm_full_roc <- roc(pretbirth_test$premature_birth37, pred_glm_full)
auc(glm_full_roc)
plot(glm_full_roc, print.auc = TRUE) # add = TRUE (to see both roc curves in one plot)
saveRDS(glm_full_roc, "case1_preterm_birth/PTB_output/ptb_37weeks/glm_full_roc.rds") 
...
# if you are interested in PTB <37w (instead of <32w), change the outcome variable to premature_birth3737
rf_cp <- ranger(premature_birth37 ~ eerder_vroeg_24_37, data = pretbirth_train_cp, num.trees = 1000,
                importance = 'impurity', probability = TRUE, seed = 8151)
# specify probability is TRUE to obtain predicted probability of outcome instead of binary prediction
...
# look at the confusionMatrix: accuracy, sensitivity, specificity and the Cohen's Kappa coefficient (Kappa accounts for the possibility of a correct prediction by chance alone (in contrast to Accuracy))
rf_cp_cm <- confusionMatrix(rf_cp_prob, pretbirth_train_cp$premature_birth37, positive = "1")
rf_cp_cm
rf_cp_cmp <- round(prop.table(confusionMatrix(rf_cp_prob, pretbirth_train_cp$premature_birth37, positive = "1")$table),4)*100
rf_cp_cmp


### Use the trained model to predict individual outcomes in the test data & evaluate predictive performance 
pred_rf_cp <- predict(rf_cp, data = pretbirth_test_cp)
#saveRDS(pred_rf_cp, "case1_preterm_birth/PTB_output/ptb_37weeks/pred_rf_cp.rds")
...
rf_cp_pred_cm <- confusionMatrix(pred_rf_cp_class, pretbirth_test_cp$premature_birth37, positive = "1")
rf_cp_pred_cm
rf_cp_pred_cmp <- round(prop.table(confusionMatrix(pred_rf_cp_class, pretbirth_test_cp$premature_birth37, positive = "1")$table),4)*100
rf_cp_pred_cmp

# look at the area under the ROC curve to assess overall model performance
rf_cp_roc <- roc(pretbirth_test_cp$premature_birth37, pred_rf_cp$predictions[,2])
auc(rf_cp_roc)
plot(rf_cp_roc, print.auc = TRUE)
saveRDS(rf_cp_roc, "case1_preterm_birth/PTB_output/ptb_37weeks/rf_cp_roc.rds") 
...
rf_cp_multi_pred_cm <- confusionMatrix(pred_rf_cp_multi_class, pretbirth_test_multi$premature_birth37, positive = "1")
rf_cp_multi_pred_cm
rf_cp_multi_pred_cmp <- round(prop.table(confusionMatrix(pred_rf_cp_multi_class, pretbirth_test_multi$premature_birth37, positive = "1")$table),4)*100
rf_cp_multi_pred_cmp

# look at the area under the ROC curve to assess overall model performance
rf_cp_multi_roc <- roc(pretbirth_test_multi$premature_birth37, pred_rf_cp_multi$predictions[,2])
auc(rf_cp_multi_roc)
plot(rf_cp_multi_roc, print.auc = TRUE)+
  abline(h = 0.348)
saveRDS(rf_cp_multi_roc, "case1_preterm_birth/PTB_output/ptb_37weeks/rf_cp_multi_roc.rds") 
...
# full models
rf_full_roc <- readRDS("case1_preterm_birth/PTB_output/rf_full_roc.rds")
auc(rf_full_roc)

rf_full37_roc <- readRDS("case1_preterm_birth/PTB_output/ptb_37weeks/rf_full37_roc.rds")
auc(rf_full37_roc)

# PTB history only models - complete sample and multiparous
rf_cp_roc <- readRDS("case1_preterm_birth/PTB_output/rf_cp_roc.rds") 
auc(rf_cp_roc)

rf_cp37_roc <- readRDS("case1_preterm_birth/PTB_output/ptb_37weeks/rf_cp37_roc.rds") 
auc(rf_cp37_roc)

rf_cp_multi_roc <- readRDS("case1_preterm_birth/PTB_output/rf_cp_multi_roc.rds")
auc(rf_cp_multi_roc)

rf_cp_multi37_roc <- readRDS("case1_preterm_birth/PTB_output/ptb_37weeks/rf_cp_multi37_roc.rds")
...
table(predictors$premature_birth37)
prop.table(table(predictors$premature_birth37)) * 100
