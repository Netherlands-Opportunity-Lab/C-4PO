...
func_postprocess_ptbhist <- function(mi_list) {
  mi_list %>% 
    select(c(premature_birth, N_vroeg_24_37))
}
...
# create a table with eerder_vroeg_23_37 and the outcome premature birth
table(mi_complete_ptbhist$'1'$eerder_vroeg_24_37, mi_complete_ptbhist$'1'$premature_birth)
table(mi_test_ptbhist$'1'$eerder_vroeg_24_37, mi_test_ptbhist$'1'$premature_birth)
table(mi_complete_ptbhist$'1'$eerder_vroeg_24_37, mi_complete_ptbhist$'1'$premature_birth) + table(mi_test_ptbhist$'1'$eerder_vroeg_24_37, mi_test_ptbhist$'1'$premature_birth)

table(mi_complete_ptbhist$'2'$eerder_vroeg_24_37, mi_complete_ptbhist$'2'$premature_birth) + table(mi_test_ptbhist$'2'$eerder_vroeg_24_37, mi_test_ptbhist$'2'$premature_birth)
table(mi_complete_ptbhist$'3'$eerder_vroeg_24_37, mi_complete_ptbhist$'3'$premature_birth) + table(mi_test_ptbhist$'3'$eerder_vroeg_24_37, mi_test_ptbhist$'3'$premature_birth)
...
rf_ptbhist <- mi_complete_ptbhist %>% 
  ...
  lapply(ranger, formula = premature_birth ~ eerder_vroeg_24_37, num.trees = 1000, importance = 'impurity', probability = TRUE, seed = 8151)
...
#saveRDS(rf_ptbhist, "case1_preterm_birth/PTB_output/rf_ptbhist.rds")
...
write_excel_csv2(pred_rf_ptbhist_pool, "case1_preterm_birth/PTB_output/pred_rf_ptbhist32_pool.csv")
...
pred_rf_ptbhist_pool_class1 <- ifelse(pred_rf_ptbhist_pool$pred_outcome_prob > 0.015, 1, 0) %>% as.factor() 
...
pred_rf_ptbhist_pool_class_cm1 <- confusionMatrix(pred_rf_ptbhist_pool_class1, mi_test_ptbhist$'1'$premature_birth, positive = "1")
pred_rf_ptbhist_pool_class_cm1
pred_rf_ptbhist_pool_class_cmp1 <- round(prop.table(confusionMatrix(pred_rf_ptbhist_pool_class1, mi_test_ptbhist$'1'$premature_birth, positive = "1")$table),4)*100
pred_rf_ptbhist_pool_class_cmp1

# look at the area under the ROC curve to assess overall model performance
rf_ptbhist_roc <- roc(mi_test_ptbhist$'1'$premature_birth, pred_rf_ptbhist_pool$pred_outcome_prob)
auc(rf_ptbhist_roc)
plot(rf_ptbhist_roc, print.auc = TRUE, col = "black", xlim = c(1, 0), ylim=c(0, 1))
saveRDS(rf_ptbhist_roc, "case1_preterm_birth/PTB_output/rf_ptbhist32_roc.rds") 
...
pred_rf_ptbhist_pool$premature_birth <- mi_test_ptbhist$'1'$premature_birth

# look at predicted probabilities by PTB outcome
PTB_rf_ptbhist_pool_cdf_1 <- pred_rf_ptbhist_pool %>% filter(premature_birth == 1)
PTB_rf_ptbhist_pool_cdf_0 <- pred_rf_ptbhist_pool %>% filter(premature_birth == 0)
...
write_excel_csv2(PTB_rf_ptbhist_pool_cdf_1_list, "case1_preterm_birth/PTB_output/PTB32_rf_ptbhist_pool_cdf_1_list.csv")
write_excel_csv2(PTB_rf_ptbhist_pool_cdf_0_list, "case1_preterm_birth/PTB_output/PTB32_rf_ptbhist_pool_cdf_0_list.csv")
...
prop.table(table(mi_test_ptbhist_multi$'1'$premature_birth))*100
...
# save the predicted probabilities for future use
write_excel_csv2(pred_rf_ptbhist_multi_pool, "case1_preterm_birth/PTB_output/pred_rf_ptbhist_multi32_pool.csv")

# classify predictions of test data; predict binary outcome using a predicted probability threshold
# this threshold is set so that everyone with eerder_vroeg_24_37 = 'ja' is classified as 1 high risk (at 0.015)
pred_rf_ptbhist_multi_pool_class1 <- ifelse(pred_rf_ptbhist_multi_pool$pred_outcome_prob > 0.02, 1, 0) %>% as.factor() 
# look at the confusionMatrix: accuracy, sensitivity, specificity and the Cohen's Kappa coefficient (Kappa accounts for the possibility of a correct prediction by chance alone (in contrast to Accuracy))
pred_rf_ptbhist_multi_pool_class_cm1 <- confusionMatrix(pred_rf_ptbhist_multi_pool_class1, mi_test_ptbhist_multi$'1'$premature_birth, positive = "1")
pred_rf_ptbhist_multi_pool_class_cm1
pred_rf_ptbhist_multi_pool_class_cmp1 <- round(prop.table(confusionMatrix(pred_rf_ptbhist_multi_pool_class1, mi_test_ptbhist_multi$'1'$premature_birth, positive = "1")$table),4)*100
pred_rf_ptbhist_multi_pool_class_cmp1


# look at the area under the ROC curve to assess overall model performance
rf_ptbhist_multi_roc <- roc(mi_test_ptbhist_multi$'1'$premature_birth, pred_rf_ptbhist_multi_pool$pred_outcome_prob)
auc(rf_ptbhist_multi_roc)
plot(rf_ptbhist_multi_roc, print.auc = TRUE, col = "black", xlim = c(1, 0), ylim=c(0, 1))
saveRDS(rf_ptbhist_multi_roc, "case1_preterm_birth/PTB_output/rf_ptbhist32_multi_roc.rds") 


### save the predicted probabilities by outcome: sample of multipara
# add the observed outcome to the data frame with predicted probabilities 
pred_rf_ptbhist_multi_pool$premature_birth <- mi_test_ptbhist_multi$'1'$premature_birth

# look at predicted probabilities by PTB outcome
PTB_rf_ptbhist_multi_pool_cdf_1 <- pred_rf_ptbhist_multi_pool %>% filter(premature_birth == 1)
PTB_rf_ptbhist_multi_pool_cdf_0 <- pred_rf_ptbhist_multi_pool %>% filter(premature_birth == 0)
...
write_excel_csv2(PTB_rf_ptbhist_multi_pool_cdf_1_list, "case1_preterm_birth/PTB_output/PTB32_rf_ptbhist_multi_pool_cdf_1_list.csv")
write_excel_csv2(PTB_rf_ptbhist_multi_pool_cdf_0_list, "case1_preterm_birth/PTB_output/PTB32_rf_ptbhist_multi_pool_cdf_0_list.csv")
# with these saved, you can later assess classification performance at various thresholds of predicted probability
...
openxlsx::write.xlsx(varimp_sheet_names, file = 'case1_preterm_birth/PTB_output/RF_VarImp_medical32_MI.xlsx')
...
# save the predicted probabilities for future use
write_excel_csv2(pred_rf_medical_pool, "case1_preterm_birth/PTB_output/pred_rf_medical32_pool.csv")

# classify predictions of test data; predict binary outcome using a predicted probability threshold
# this threshold is set a prevalence, we predict a high risk of PTB for approx. 0.81% of pregnancies
pred_rf_medical_pool_class1 <- ifelse(pred_rf_medical_pool$pred_outcome_prob > 0.032, 1, 0) %>% as.factor() 
# look at the confusionMatrix: accuracy, sensitivity, specificity and the Cohen's Kappa coefficient (Kappa accounts for the possibility of a correct prediction by chance alone (in contrast to Accuracy))
pred_rf_medical_pool_class_cm1 <- confusionMatrix(pred_rf_medical_pool_class1, mi_test_medical$'1'$premature_birth, positive = "1")
pred_rf_medical_pool_class_cm1
pred_rf_medical_pool_class_cmp1 <- round(prop.table(confusionMatrix(pred_rf_medical_pool_class1, mi_test_medical$'1'$premature_birth, positive = "1")$table),4)*100
pred_rf_medical_pool_class_cmp1

# try different thresholds: > 0.0165 approx. 10% highest risks
pred_rf_medical_pool_class10 <- ifelse(pred_rf_medical_pool$pred_outcome_prob > 0.0165, 1, 0) %>% as.factor() 
# look at the confusionMatrix: accuracy, sensitivity, specificity and the Cohen's Kappa coefficient (Kappa accounts for the possibility of a correct prediction by chance alone (in contrast to Accuracy))
pred_rf_medical_pool_class_cm10 <- confusionMatrix(pred_rf_medical_pool_class10, mi_test_medical$'1'$premature_birth, positive = "1")
pred_rf_medical_pool_class_cm10
pred_rf_medical_pool_class_cmp10 <- round(prop.table(confusionMatrix(pred_rf_medical_pool_class10, mi_test_medical$'1'$premature_birth, positive = "1")$table),4)*100
pred_rf_medical_pool_class_cmp10

# try different thresholds: > 0.01 approx. 15% highest risks
pred_rf_medical_pool_class15 <- ifelse(pred_rf_medical_pool$pred_outcome_prob > 0.01, 1, 0) %>% as.factor() 
# look at the confusionMatrix: accuracy, sensitivity, specificity and the Cohen's Kappa coefficient (Kappa accounts for the possibility of a correct prediction by chance alone (in contrast to Accuracy))
pred_rf_medical_pool_class_cm15 <- confusionMatrix(pred_rf_medical_pool_class15, mi_test_medical$'1'$premature_birth, positive = "1")
pred_rf_medical_pool_class_cm15
pred_rf_medical_pool_class_cmp15 <- round(prop.table(confusionMatrix(pred_rf_medical_pool_class15, mi_test_medical$'1'$premature_birth, positive = "1")$table),4)*100
pred_rf_medical_pool_class_cmp15

# look at the area under the ROC curve to assess overall model performance
rf_medical_roc <- roc(mi_test_medical$'1'$premature_birth, pred_rf_medical_pool$pred_outcome_prob)
auc(rf_medical_roc)
plot(rf_medical_roc, print.auc = TRUE, col = "black", xlim = c(1, 0), ylim=c(0, 1))
saveRDS(rf_medical_roc, "case1_preterm_birth/PTB_output/rf_medical32_roc.rds") 


### save the predicted probabilities by outcome: population sample
# add the observed outcome to the data frame with predicted probabilities 
pred_rf_medical_pool$premature_birth <- mi_test_medical$'1'$premature_birth

# look at predicted probabilities by PTB outcome
PTB_rf_medical_pool_cdf_1 <- pred_rf_medical_pool %>% filter(premature_birth == 1)
PTB_rf_medical_pool_cdf_0 <- pred_rf_medical_pool %>% filter(premature_birth == 0)
...
write_excel_csv2(PTB_rf_medical_pool_cdf_1_list, "case1_preterm_birth/PTB_output/PTB32_rf_medical_pool_cdf_1_list.csv")
write_excel_csv2(PTB_rf_medical_pool_cdf_0_list, "case1_preterm_birth/PTB_output/PTB32_rf_medical_pool_cdf_0_list.csv")
# with these saved, you can later assess classification performance at various thresholds of predicted probability
...
prop.table(table(mi_test_medical_multi$'1'$premature_birth))*100
...
# save the predicted probabilities for future use
write_excel_csv2(pred_rf_medical_multi_pool, "case1_preterm_birth/PTB_output/pred_rf_medical_multi32_pool.csv")

# classify predictions of test data; predict binary outcome using a predicted probability threshold
# this threshold is set a prevalence, we predict a high risk of PTB for approx. 0.556% of pregnancies
pred_rf_medical_multi_pool_class1 <- ifelse(pred_rf_medical_multi_pool$pred_outcome_prob > 0.06, 1, 0) %>% as.factor() 
# look at the confusionMatrix: accuracy, sensitivity, specificity and the Cohen's Kappa coefficient (Kappa accounts for the possibility of a correct prediction by chance alone (in contrast to Accuracy))
pred_rf_medical_multi_pool_class_cm1 <- confusionMatrix(pred_rf_medical_multi_pool_class1, mi_test_medical_multi$'1'$premature_birth, positive = "1")
pred_rf_medical_multi_pool_class_cm1
pred_rf_medical_multi_pool_class_cmp1 <- round(prop.table(confusionMatrix(pred_rf_medical_multi_pool_class1, mi_test_medical_multi$'1'$premature_birth, positive = "1")$table),4)*100
pred_rf_medical_multi_pool_class_cmp1

# try different thresholds: > 0.0107 approx. 10% highest risks
pred_rf_medical_multi_pool_class10 <- ifelse(pred_rf_medical_multi_pool$pred_outcome_prob > 0.0107, 1, 0) %>% as.factor() 
# look at the confusionMatrix: accuracy, sensitivity, specificity and the Cohen's Kappa coefficient (Kappa accounts for the possibility of a correct prediction by chance alone (in contrast to Accuracy))
pred_rf_medical_multi_pool_class_cm10 <- confusionMatrix(pred_rf_medical_multi_pool_class10, mi_test_medical_multi$'1'$premature_birth, positive = "1")
pred_rf_medical_multi_pool_class_cm10
pred_rf_medical_multi_pool_class_cmp10 <- round(prop.table(confusionMatrix(pred_rf_medical_multi_pool_class10, mi_test_medical_multi$'1'$premature_birth, positive = "1")$table),4)*100
pred_rf_medical_multi_pool_class_cmp10

# try different thresholds: > 0.0087 approx. 15% highest risks
pred_rf_medical_multi_pool_class15 <- ifelse(pred_rf_medical_multi_pool$pred_outcome_prob > 0.0087, 1, 0) %>% as.factor() 
# look at the confusionMatrix: accuracy, sensitivity, specificity and the Cohen's Kappa coefficient (Kappa accounts for the possibility of a correct prediction by chance alone (in contrast to Accuracy))
pred_rf_medical_multi_pool_class_cm15 <- confusionMatrix(pred_rf_medical_multi_pool_class15, mi_test_medical_multi$'1'$premature_birth, positive = "1")
pred_rf_medical_multi_pool_class_cm15
pred_rf_medical_multi_pool_class_cmp15 <- round(prop.table(confusionMatrix(pred_rf_medical_multi_pool_class15, mi_test_medical_multi$'1'$premature_birth, positive = "1")$table),4)*100
pred_rf_medical_multi_pool_class_cmp15

# look at the area under the ROC curve to assess overall model performance
rf_medical_multi_roc <- roc(mi_test_medical_multi$'1'$premature_birth, pred_rf_medical_multi_pool$pred_outcome_prob)
auc(rf_medical_multi_roc)
plot(rf_medical_multi_roc, print.auc = TRUE, col = "black", xlim = c(1, 0), ylim=c(0, 1))
saveRDS(rf_medical_multi_roc, "case1_preterm_birth/PTB_output/rf_medical32_multi_roc.rds") 


### save the predicted probabilities by outcome: sample of multipara
# add the observed outcome to the data frame with predicted probabilities 
pred_rf_medical_multi_pool$premature_birth <- mi_test_medical_multi$'1'$premature_birth

# look at predicted probabilities by PTB outcome
PTB_rf_medical_multi_pool_cdf_1 <- pred_rf_medical_multi_pool %>% filter(premature_birth == 1)
PTB_rf_medical_multi_pool_cdf_0 <- pred_rf_medical_multi_pool %>% filter(premature_birth == 0)
...
write_excel_csv2(PTB_rf_medical_multi_pool_cdf_1_list, "case1_preterm_birth/PTB_output/PTB32_rf_medical_multi_pool_cdf_1_list.csv")
write_excel_csv2(PTB_rf_medical_multi_pool_cdf_0_list, "case1_preterm_birth/PTB_output/PTB32_rf_medical_multi_pool_cdf_0_list.csv")
# with these saved, you can later assess classification performance at various thresholds of predicted probability
...
mi_test_medical_primi <- lapply(mi_test_medical, function(mi_list){
  filter(mi_list, interpreg_cat == "nvt" & N_vroeg_24_37 == "nvt")})
table(mi_test_medical_primi$'2'$premature_birth)
prop.table(table(mi_test_medical_primi$'1'$premature_birth))*100
...
# save the predicted probabilities for future use
write_excel_csv2(pred_rf_medical_primi_pool, "case1_preterm_birth/PTB_output/pred_rf_medical_primi32_pool.csv")

# classify predictions of test data; predict binary outcome using a predicted probability threshold
# this threshold is set a prevalence, we predict a high risk of PTB for approx. 1.097% of pregnancies
pred_rf_medical_primi_pool_class1 <- ifelse(pred_rf_medical_primi_pool$pred_outcome_prob > 0.0275, 1, 0) %>% as.factor() 
# look at the confusionMatrix: accuracy, sensitivity, specificity and the Cohen's Kappa coefficient (Kappa accounts for the possibility of a correct prediction by chance alone (in contrast to Accuracy))
pred_rf_medical_primi_pool_class_cm1 <- confusionMatrix(pred_rf_medical_primi_pool_class1, mi_test_medical_primi$'1'$premature_birth, positive = "1")
pred_rf_medical_primi_pool_class_cm1
pred_rf_medical_primi_pool_class_cmp1 <- round(prop.table(confusionMatrix(pred_rf_medical_primi_pool_class1, mi_test_medical_primi$'1'$premature_birth, positive = "1")$table),4)*100
pred_rf_medical_primi_pool_class_cmp1

# try different thresholds: > 0.024 approx. 10% highest risks
pred_rf_medical_primi_pool_class10 <- ifelse(pred_rf_medical_primi_pool$pred_outcome_prob > 0.024, 1, 0) %>% as.factor() 
# look at the confusionMatrix: accuracy, sensitivity, specificity and the Cohen's Kappa coefficient (Kappa accounts for the possibility of a correct prediction by chance alone (in contrast to Accuracy))
pred_rf_medical_primi_pool_class_cm10 <- confusionMatrix(pred_rf_medical_primi_pool_class10, mi_test_medical_primi$'1'$premature_birth, positive = "1")
pred_rf_medical_primi_pool_class_cm10
pred_rf_medical_primi_pool_class_cmp10 <- round(prop.table(confusionMatrix(pred_rf_medical_primi_pool_class10, mi_test_medical_primi$'1'$premature_birth, positive = "1")$table),4)*100
pred_rf_medical_primi_pool_class_cmp10

# try different thresholds: > 0.021 approx. 15% highest risks
pred_rf_medical_primi_pool_class15 <- ifelse(pred_rf_medical_primi_pool$pred_outcome_prob > 0.021, 1, 0) %>% as.factor() 
# look at the confusionMatrix: accuracy, sensitivity, specificity and the Cohen's Kappa coefficient (Kappa accounts for the possibility of a correct prediction by chance alone (in contrast to Accuracy))
pred_rf_medical_primi_pool_class_cm15 <- confusionMatrix(pred_rf_medical_primi_pool_class15, mi_test_medical_primi$'1'$premature_birth, positive = "1")
pred_rf_medical_primi_pool_class_cm15
pred_rf_medical_primi_pool_class_cmp15 <- round(prop.table(confusionMatrix(pred_rf_medical_primi_pool_class15, mi_test_medical_primi$'1'$premature_birth, positive = "1")$table),4)*100
pred_rf_medical_primi_pool_class_cmp15


# look at the area under the ROC curve to assess overall model performance
rf_medical_primi_roc <- roc(mi_test_medical_primi$'1'$premature_birth, pred_rf_medical_primi_pool$pred_outcome_prob)
auc(rf_medical_primi_roc)
plot(rf_medical_primi_roc, print.auc = TRUE, col = "black", xlim = c(1, 0), ylim=c(0, 1))
saveRDS(rf_medical_primi_roc, "case1_preterm_birth/PTB_output/rf_medical32_primi_roc.rds") 

### save the predicted probabilities by outcome: sample of primipara
# add the observed outcome to the data frame with predicted probabilities 
pred_rf_medical_primi_pool$premature_birth <- mi_test_medical_primi$'1'$premature_birth

# look at predicted probabilities by PTB outcome
PTB_rf_medical_primi_pool_cdf_1 <- pred_rf_medical_primi_pool %>% filter(premature_birth == 1)
PTB_rf_medical_primi_pool_cdf_0 <- pred_rf_medical_primi_pool %>% filter(premature_birth == 0)
...
write_excel_csv2(PTB_rf_medical_primi_pool_cdf_1_list, "case1_preterm_birth/PTB_output/PTB32_rf_medical_primi_pool_cdf_1_list.csv")
write_excel_csv2(PTB_rf_medical_primi_pool_cdf_0_list, "case1_preterm_birth/PTB_output/PTB32_rf_medical_primi_pool_cdf_0_list.csv")
# with these saved, you can later assess classification performance at various thresholds of predicted probability
...
rf_ptbhist_roc <- readRDS("case1_preterm_birth/PTB_output/rf_ptbhist32_roc.rds") 
auc(rf_ptbhist_roc)
rf_ptbhist_multi_roc <- readRDS("case1_preterm_birth/PTB_output/rf_ptbhist32_multi_roc.rds") 
auc(rf_ptbhist_multi_roc)
...
legend("topleft", legend = c("PTB <32w restricted", "PTB <32w restricted multi", "PTB <32w history only", "PTB <32w history only multi"), 
...
for (var_i in names(mi_complete$'1')[-1]) {
  ...
  formula_i <- as.formula(paste("premature_birth ~", var_i))
  ...
  # look at the area under the ROC curve to assess overall model performance
  rf_rest_roc_i <- roc(mi_test_comp$'1'$premature_birth, pred_rf_rest_pool_i$pred_outcome_prob)
...
openxlsx::write.xlsx(df_auc, "case1_preterm_birth/PTB_output/rfmodel_df_auc.xlsx")
